...
></textarea>
        ...
        <button type="submit" className="bg-orange-600  py-3 px-11 text-white border-2 rounded-lg border-none">
          Add Todo
        </button>
      </form>
      ...
      <div className="relative overflow-x-auto mt-24 w-[60%] mx-auto">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:gray-700 dark:text-gray-400">
            <tr>
